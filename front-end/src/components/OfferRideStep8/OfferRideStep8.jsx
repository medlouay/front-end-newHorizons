...
import "./OfferRideStep8.css";

export const OfferRideStep8 = ({ ...props }) => {
  return (
    <div className="offer-ride-step-8">
      <svg
        className="x"
        width="18"
        height="18"
      ...
      <div className="frame-113">
        ...
        <div className="frame-97">
          <div className="select-on-map-1">Select on map</div>
