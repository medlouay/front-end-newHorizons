...
import "./OfferRideStep6.css";

export const OfferRideStep6 = ({ ...props }) => {
  return (
    <div className="offer-ride-step-6">
      <svg
        className="x"
        width="18"
        height="18"
      ...
      <div className="frame-119">
        <div className="departure-estimated-date-and-time6">
      ...
      <div className="frame-113">
        <div className="frame-102">
          ...
          <div className="frame-962">
            <div className="frame-106">
              <div className="input-exact-address">Input exact address</div>
        ...
        <div className="select-on-map66-1">Select on map</div>
        <svg
            className="chevron-left61"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            fill="none"
      ...
      <div className="frame-118">
        <div className="frame-102">
          <div className="also-stops-in">Also stops in</div>

          <div className="frame-962">
            <div className="frame-1062">
              <div className="input-exact-address2">Input exact address</div>
        ...
        <div className="frame-97">
          <div className="select-on-map6-1">Select on map</div>
      ...
      <div className="frame-88">
        <div className="frame-87">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M0 0H136" stroke="#ED8A37" strokeLinecap="round" />
          </svg>
        </div>

        <div className="ride-from-the-event">Ride from the event</div>
      </div>
      ...
      <div className="frame-120-6">
        ...
        <div className="date-and-time-will-be-automatically-calculated">
          Date and time will be automatically calculated
        </div>
      </div>
 ...
 <div className="select-on-map62">Select on map</div>;
 <svg
      className="chevron-left62"
      width="16"
      height="16"
      viewBox="0 0 16 16"
      fill="none"
